// ======================================================================
// BusAnalyzer.v generated from TopDesign.cysch
// 12/29/2024 at 21:53
...
module top ;
	...
	cy_clock_v1_0
		#(.id("50df562d-cff4-47df-b0c0-0970de8fd62f"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__Ctrl_Reset_net;
	wire [0:0] tmpFB_0__Ctrl_Reset_net;
	wire [0:0] tmpIO_0__Ctrl_Reset_net;
	wire [0:0] tmpINTERRUPT_0__Ctrl_Reset_net;
	electrical [0:0] tmpSIOVREF__Ctrl_Reset_net;

	cy_psoc3_pins_v1_10
		#(.id("3108cdd8-a109-48f4-8aaf-aa308ad8ef36"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Ctrl_Reset
		 (.oe(tmpOE__Ctrl_Reset_net),
		  .y({Net_10}),
		  .fb({tmpFB_0__Ctrl_Reset_net[0:0]}),
		  .io({tmpIO_0__Ctrl_Reset_net[0:0]}),
		  .siovref(tmpSIOVREF__Ctrl_Reset_net),
		  .interrupt({tmpINTERRUPT_0__Ctrl_Reset_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Ctrl_Reset_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("1923ed0c-b60a-436c-97d0-c77134b512c4"),
		  .drive_mode(24'b111_111_111_111_111_111_111_111),
	...
	wire [7:0] tmpOE__Addr_LSB_net;
	wire [7:0] tmpFB_7__Addr_LSB_net;
	wire [7:0] tmpIO_7__Addr_LSB_net;
	wire [0:0] tmpINTERRUPT_0__Addr_LSB_net;
	electrical [0:0] tmpSIOVREF__Addr_LSB_net;

	cy_psoc3_pins_v1_10
		#(.id("7c245cda-0a8f-4041-bb05-f4508c9ad190"),
		  ...
		  .input_buffer_sel(16'b00_00_00_00_00_00_00_00))
		Addr_LSB
		 (.oe(tmpOE__Addr_LSB_net),
		  .y({8'b0}),
		  .fb({tmpFB_7__Addr_LSB_net[7:0]}),
		  .io({tmpIO_7__Addr_LSB_net[7:0]}),
		  .siovref(tmpSIOVREF__Addr_LSB_net),
		  .interrupt({tmpINTERRUPT_0__Addr_LSB_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Addr_LSB_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{8'b11111111} : {8'b11111111};
    ...
    begin : mux_1
        reg  tmp__mux_1_reg;
        always @(Net_46 or Net_47 or Net_63)
        begin
            case (Net_63)
                1'b0 :  tmp__mux_1_reg = Net_46;
                1'b1 :  tmp__mux_1_reg = Net_47;
            endcase
        end
        assign Net_36 = tmp__mux_1_reg;
    end
    // -- Mux end --

    CyControlReg_v1_80 Clock_Ctrl (
        .clock(1'b0),
        .control_0(Net_47),
        .control_1(Net_63),
        .control_2(Net_53),
        ...
        .control_7(Net_59),
        .reset(1'b0));
    defparam Clock_Ctrl.Bit0Mode = 0;
    defparam Clock_Ctrl.Bit1Mode = 0;
    defparam Clock_Ctrl.Bit2Mode = 0;
    defparam Clock_Ctrl.Bit3Mode = 0;
    defparam Clock_Ctrl.Bit4Mode = 0;
    defparam Clock_Ctrl.Bit5Mode = 0;
    defparam Clock_Ctrl.Bit6Mode = 0;
    defparam Clock_Ctrl.Bit7Mode = 0;
    defparam Clock_Ctrl.BitValue = 0;
    defparam Clock_Ctrl.BusDisplay = 0;
    defparam Clock_Ctrl.ExtrReset = 0;
    defparam Clock_Ctrl.NumOutputs = 2;

	wire [0:0] tmpOE__Ctrl_M1_net;
	wire [0:0] tmpFB_0__Ctrl_M1_net;
	wire [0:0] tmpIO_0__Ctrl_M1_net;
	wire [0:0] tmpINTERRUPT_0__Ctrl_M1_net;
	electrical [0:0] tmpSIOVREF__Ctrl_M1_net;

	cy_psoc3_pins_v1_10
		#(.id("767e50ee-23c6-494d-82b2-57968ffc5247"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Ctrl_M1
		 (.oe(tmpOE__Ctrl_M1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Ctrl_M1_net[0:0]}),
		  .io({tmpIO_0__Ctrl_M1_net[0:0]}),
		  .siovref(tmpSIOVREF__Ctrl_M1_net),
		  .interrupt({tmpINTERRUPT_0__Ctrl_M1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Ctrl_M1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Ctrl_RD_net;
	wire [0:0] tmpFB_0__Ctrl_RD_net;
	wire [0:0] tmpIO_0__Ctrl_RD_net;
	wire [0:0] tmpINTERRUPT_0__Ctrl_RD_net;
	electrical [0:0] tmpSIOVREF__Ctrl_RD_net;

	cy_psoc3_pins_v1_10
		#(.id("de4a039a-10f2-460d-8ae7-1816b07e619e"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Ctrl_RD
		 (.oe(tmpOE__Ctrl_RD_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Ctrl_RD_net[0:0]}),
		  .io({tmpIO_0__Ctrl_RD_net[0:0]}),
		  .siovref(tmpSIOVREF__Ctrl_RD_net),
		  .interrupt({tmpINTERRUPT_0__Ctrl_RD_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Ctrl_RD_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Ctrl_WR_net;
	wire [0:0] tmpFB_0__Ctrl_WR_net;
	wire [0:0] tmpIO_0__Ctrl_WR_net;
	wire [0:0] tmpINTERRUPT_0__Ctrl_WR_net;
	electrical [0:0] tmpSIOVREF__Ctrl_WR_net;

	cy_psoc3_pins_v1_10
		#(.id("538f5ace-ff22-425b-9a02-bb794d3c98b9"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Ctrl_WR
		 (.oe(tmpOE__Ctrl_WR_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Ctrl_WR_net[0:0]}),
		  .io({tmpIO_0__Ctrl_WR_net[0:0]}),
		  .siovref(tmpSIOVREF__Ctrl_WR_net),
		  .interrupt({tmpINTERRUPT_0__Ctrl_WR_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Ctrl_WR_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Ctrl_MREQ_net;
	wire [0:0] tmpFB_0__Ctrl_MREQ_net;
	wire [0:0] tmpIO_0__Ctrl_MREQ_net;
	wire [0:0] tmpINTERRUPT_0__Ctrl_MREQ_net;
	electrical [0:0] tmpSIOVREF__Ctrl_MREQ_net;

	cy_psoc3_pins_v1_10
		#(.id("028c84d0-2e85-40c7-9136-a694206a0a9c"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Ctrl_MREQ
		 (.oe(tmpOE__Ctrl_MREQ_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Ctrl_MREQ_net[0:0]}),
		  .io({tmpIO_0__Ctrl_MREQ_net[0:0]}),
		  .siovref(tmpSIOVREF__Ctrl_MREQ_net),
		  .interrupt({tmpINTERRUPT_0__Ctrl_MREQ_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Ctrl_MREQ_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
