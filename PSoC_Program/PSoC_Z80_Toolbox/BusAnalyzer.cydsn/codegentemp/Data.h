...
/* Interrupt Registers */
	...
	#define Data_1_INTTYPE_REG 		(* (reg8 *) Data__1__INTTYPE)
	#define Data_2_INTTYPE_REG 		(* (reg8 *) Data__2__INTTYPE)
	#define Data_3_INTTYPE_REG 		(* (reg8 *) Data__3__INTTYPE)
	#define Data_4_INTTYPE_REG 		(* (reg8 *) Data__4__INTTYPE)
	#define Data_5_INTTYPE_REG 		(* (reg8 *) Data__5__INTTYPE)
	#define Data_6_INTTYPE_REG 		(* (reg8 *) Data__6__INTTYPE)
	#define Data_7_INTTYPE_REG 		(* (reg8 *) Data__7__INTTYPE)
#endif /* (Data__INTSTAT) */
