...
{
    uint8 staticBits = (User_Button_DR & (uint8)(~User_Button_MASK));
    User_Button_DR = staticBits | ((uint8)(value << User_Button_SHIFT) & User_Button_MASK);
}
...
{
	CyPins_SetPinDriveMode(User_Button_0, mode);
}
...
{
    return (User_Button_PS & User_Button_MASK) >> User_Button_SHIFT;
}
...
{
    return (User_Button_DR & User_Button_MASK) >> User_Button_SHIFT;
}
...
/* If interrupt is connected for this Pins component */ 
    ...
    *******************************************************************************/
    ...
    {
		if((position & User_Button_0_INTR) != 0u) 
		{ 
			 User_Button_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (User_Button_INTSTAT & User_Button_MASK) >> User_Button_SHIFT;
    }
