...
*
* \funcusage
*  \snippet Clk_SUT.c usage_Clk_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Clk_SUT.c usage_Clk_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Clk_SUT.c usage_Clk_Read  
*******************************************************************************/
uint8 Clk_Read(void)
{
...
* preferred Clk_Read() API because the 
* Clk_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Clk_SUT.c usage_Clk_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Clk_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Clk_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Clk_0_INTR       (First pin in the list)
    *  - Clk_1_INTR       (Second pin in the list)
    *  - ...
    *  - Clk_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Clk_SUT.c usage_Clk_SetInterruptMode
    *******************************************************************************/
    void Clk_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Clk_0_INTR) != 0u) 
		{ 
			 Clk_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Clk_SUT.c usage_Clk_ClearInterrupt
    *******************************************************************************/
