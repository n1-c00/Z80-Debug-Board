// ======================================================================
// ROM_in_PSoC.v generated from TopDesign.cysch
// 01/17/2025 at 10:31
...
module top ;
    ...
    assign Net_3 = Net_4 & Net_2;

	wire [0:0] tmpOE__MREQ_net;
	wire [0:0] tmpIO_0__MREQ_net;
	wire [0:0] tmpINTERRUPT_0__MREQ_net;
	electrical [0:0] tmpSIOVREF__MREQ_net;
	...
	cy_psoc3_pins_v1_10
		...
		MREQ
		 (.oe(tmpOE__MREQ_net),
		  .y({1'b0}),
		  .fb({Net_29}),
		  .io({tmpIO_0__MREQ_net[0:0]}),
		  .siovref(tmpSIOVREF__MREQ_net),
		  .interrupt({tmpINTERRUPT_0__MREQ_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MREQ_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Read_net;
	wire [0:0] tmpIO_0__Read_net;
	wire [0:0] tmpINTERRUPT_0__Read_net;
	electrical [0:0] tmpSIOVREF__Read_net;

	cy_psoc3_pins_v1_10
		#(.id("84793a88-8287-48e5-bf23-d28ceea504ea"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		Read
		 (.oe(tmpOE__Read_net),
		  .y({1'b0}),
		  .fb({Net_27}),
		  .io({tmpIO_0__Read_net[0:0]}),
		  .siovref(tmpSIOVREF__Read_net),
		  .interrupt({tmpINTERRUPT_0__Read_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Read_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("0a1afd38-5a75-4127-a124-8fb04879c9cd"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__Clock_out_net;
	wire [0:0] tmpFB_0__Clock_out_net;
	wire [0:0] tmpIO_0__Clock_out_net;
	wire [0:0] tmpINTERRUPT_0__Clock_out_net;
	electrical [0:0] tmpSIOVREF__Clock_out_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		Clock_out
		 (.oe(tmpOE__Clock_out_net),
		  .y({Net_20}),
		  .fb({tmpFB_0__Clock_out_net[0:0]}),
		  .io({tmpIO_0__Clock_out_net[0:0]}),
		  .siovref(tmpSIOVREF__Clock_out_net),
		  .interrupt({tmpINTERRUPT_0__Clock_out_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Clock_out_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Reset_out_net;
	wire [0:0] tmpFB_0__Reset_out_net;
	wire [0:0] tmpIO_0__Reset_out_net;
	wire [0:0] tmpINTERRUPT_0__Reset_out_net;
	electrical [0:0] tmpSIOVREF__Reset_out_net;

	cy_psoc3_pins_v1_10
		#(.id("6142fa98-b978-4fd4-bba8-2792db4e55fa"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Reset_out
		 (.oe(tmpOE__Reset_out_net),
		  .y({Net_22}),
		  .fb({tmpFB_0__Reset_out_net[0:0]}),
		  .io({tmpIO_0__Reset_out_net[0:0]}),
		  .siovref(tmpSIOVREF__Reset_out_net),
		  .interrupt({tmpINTERRUPT_0__Reset_out_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Reset_out_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("f05f0e87-7c38-422d-884b-e0be714a240b"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
