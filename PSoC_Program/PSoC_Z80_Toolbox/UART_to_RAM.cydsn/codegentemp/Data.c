...
/* If interrupt is connected for this Pins component */ 
    ...
    *******************************************************************************/
    void Data_SetInterruptMode(uint16 position, uint16 mode)
    {
		...
		if((position & Data_1_INTR) != 0u) 
		{ 
			 Data_1_INTTYPE_REG = (uint8)mode; 
		} 
		if((position & Data_2_INTR) != 0u) 
		{ 
			 Data_2_INTTYPE_REG = (uint8)mode; 
		} 
		if((position & Data_3_INTR) != 0u) 
		{ 
			 Data_3_INTTYPE_REG = (uint8)mode; 
		} 
		if((position & Data_4_INTR) != 0u) 
		{ 
			 Data_4_INTTYPE_REG = (uint8)mode; 
		} 
		if((position & Data_5_INTR) != 0u) 
		{ 
			 Data_5_INTTYPE_REG = (uint8)mode; 
		} 
		if((position & Data_6_INTR) != 0u) 
		{ 
			 Data_6_INTTYPE_REG = (uint8)mode; 
		} 
		if((position & Data_7_INTR) != 0u) 
		{ 
			 Data_7_INTTYPE_REG = (uint8)mode; 
		}
    }
