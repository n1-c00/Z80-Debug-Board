// ======================================================================
// UART_to_RAM.v generated from TopDesign.cysch
// 01/15/2025 at 14:53
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .vtrip(16'b00_10_10_10_10_10_10_10),
		  .width(8),
	...
	wire [7:0] tmpOE__Address_LSB_net;
	wire [7:0] tmpFB_7__Address_LSB_net;
	wire [7:0] tmpIO_7__Address_LSB_net;
	wire [0:0] tmpINTERRUPT_0__Address_LSB_net;
	electrical [0:0] tmpSIOVREF__Address_LSB_net;

	cy_psoc3_pins_v1_10
		#(.id("3ef02a29-cfae-44ab-b842-8ab6d4ed143f"),
		  ...
		  .input_buffer_sel(16'b00_00_00_00_00_00_00_00))
		Address_LSB
		 (.oe(tmpOE__Address_LSB_net),
		  .y({8'b0}),
		  .fb({tmpFB_7__Address_LSB_net[7:0]}),
		  .io({tmpIO_7__Address_LSB_net[7:0]}),
		  .siovref(tmpSIOVREF__Address_LSB_net),
		  .interrupt({tmpINTERRUPT_0__Address_LSB_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Address_LSB_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{8'b11111111} : {8'b11111111};

	wire [2:0] tmpOE__Address_MSB_net;
	wire [2:0] tmpFB_2__Address_MSB_net;
	wire [2:0] tmpIO_2__Address_MSB_net;
	wire [0:0] tmpINTERRUPT_0__Address_MSB_net;
	electrical [0:0] tmpSIOVREF__Address_MSB_net;

	cy_psoc3_pins_v1_10
		#(.id("3cfb3e08-bb09-4c96-92d0-f38d5cd67be3"),
		...
		Address_MSB
		 (.oe(tmpOE__Address_MSB_net),
		  .y({3'b0}),
		  .fb({tmpFB_2__Address_MSB_net[2:0]}),
		  .io({tmpIO_2__Address_MSB_net[2:0]}),
		  .siovref(tmpSIOVREF__Address_MSB_net),
		  .interrupt({tmpINTERRUPT_0__Address_MSB_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Address_MSB_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{3'b111} : {3'b111};
	...
	cy_psoc3_pins_v1_10
		#(.id("e98d590a-16e3-442e-82b3-1263e5853a00"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Write_net;
	wire [0:0] tmpFB_0__Write_net;
	wire [0:0] tmpIO_0__Write_net;
	wire [0:0] tmpINTERRUPT_0__Write_net;
	electrical [0:0] tmpSIOVREF__Write_net;

	cy_psoc3_pins_v1_10
		#(.id("17051177-3068-4fbe-97b1-fa9bf8783951"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		Write
		 (.oe(tmpOE__Write_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Write_net[0:0]}),
		  .io({tmpIO_0__Write_net[0:0]}),
		  .siovref(tmpSIOVREF__Write_net),
		  .interrupt({tmpINTERRUPT_0__Write_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Write_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
